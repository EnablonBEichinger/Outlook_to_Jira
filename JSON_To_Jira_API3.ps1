...
$fileConfirmation = Read-Host "Continue with this file? (Y/N)"
if ($fileConfirmation -notin @('Y', 'y')) {
...
$confirmation = Read-Host "Are you happy with these dates for the start and end of the week? (Y/N)"
